...
var cards = [
  {
    title: "Profile",
    width: 280,
    html: `<div class="profile-image"><img src="${imagePath}/selfie.jpg" alt="snowman"></div>
		<div class="profile-info">
			<table>
				<tbody>
					<tr><td>Name</td><td>Shubham Sharma</td></tr>
					<tr><td>Resume</td><td><a href="images/RESUME2024.pdf" download>Download Resume</a></td></tr>
					<tr>
            <td>Reach Out</td>
            <td>
              <a href="mailto:shubhamsha.rma@outlook.com"><i class="fas fa-envelope"></i></a>
              <a href="https://www.linkedin.com/in/shubhams1-/"><i class="fab fa-linkedin-in"></i></a>
              <a href="https://x.com/shubhams1_"><i class="fab fa-twitter"></i></a>
              <a href="https://github.com/booringreader" target="_blank"><i class="fab fa-github"></i></a>
            </td>
          </tr>
				</tbody>
			</table>
  ...
  },
  {
    ...
    html: `<div class="face-capture-image">
			<img src="${imagePath}/face-capture.jpg" alt="snowman Facial Recognition">
  ...
  // 			<img class="finland-map" src="${imagePath}/in.svg" alt="Finland Map">
...
if (window.location.pathname === "/") {
  new Terminal({
    ...
    commands: [
      {
        text: 'initialize payload -a',
        typing: true,
      },
      {
        text: "grep | load profile",
        typing: true,
      },
      {
        text: "loading...",
